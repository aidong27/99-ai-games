...
for (const record of records) {
  ...
  for (const runRecord of record.runs) {
    ...
    runs.push({
      ...
      parentSourceHash: runRecord.run.parentSourceHash,
      knownIssues: runRecord.run.knownIssues ?? [],
      toolAccess: runRecord.run.toolAccess,
      environment: runRecord.run.environment,
